...
public class RecommendedMenu implements Parcelable {
    ...
    protected RecommendedMenu(Parcel in) {
    ...
    public static final Creator<RecommendedMenu> CREATOR = new Creator<RecommendedMenu>() {
        @Override
        public RecommendedMenu createFromParcel(Parcel in) {
            return new RecommendedMenu(in);
        }

        @Override
        public RecommendedMenu[] newArray(int size) {
            return new RecommendedMenu[size];
        }
    };
