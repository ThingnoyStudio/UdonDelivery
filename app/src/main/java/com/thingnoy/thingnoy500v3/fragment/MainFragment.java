...
import com.thingnoy.thingnoy500v3.activity.MainActivity;
import com.thingnoy.thingnoy500v3.activity.MoreInfoActivity;
...
//                    PhotoListManager.getInstance().setDao(dao);//ยัด data ให้กับ PhotoListManager เมื่อจะใช้ข้อมูลให้เรียก PhotoListManager แทน
