package com.thingnoy.thingnoy500v3.ui.ordering.ordersuccess;
...
import com.thingnoy.thingnoy500v3.ui.ordering.ordersuccess.adapter.OrderSuccessAdapter;
import com.thingnoy.thingnoy500v3.util.GetPrettyPrintJson;

import java.util.List;

import static com.thingnoy.thingnoy500v3.ui.ordering.payment.PaymentFragment.COD;
...
public class DialogOrderSuccessFragment extends DialogFragment implements DialogInterface.OnDismissListener {
    ...
    private ImageView ivPicPayment;
    ...
    private void bindView(View root_view) {
        ...
        ivPicPayment = root_view.findViewById(R.id.iv_payment_logo);
...
//        tvTime.setText(dao.getmOrderDate());//
        ...
        if (dao.getmPaymentType() == COD ){
            tvPayType.setText("ชำระเงินปลายทาง");
            ivPicPayment.setImageResource(R.drawable.ic_payment_black_24dp);
        }else {
            tvPayType.setText("ชำระเงินผ่านPayPal");
            ivPicPayment.setImageResource(R.drawable.ic_paypal);
        }
        ...
        if (dao.getmPay() > 0){
            ...
            tvPay.setText("จำนวนเงินที่เตรียมจ่าย: 0 ฿");
        }
